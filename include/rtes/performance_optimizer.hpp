...
public:
    static bool parse_symbol(std::string_view input, char* output, size_t max_len) noexcept;
    static uint64_t parse_uint64(std::string_view input) noexcept;
    static double parse_price(std::string_view input) noexcept;
    static bool is_valid_symbol_fast(std::string_view symbol) noexcept;
