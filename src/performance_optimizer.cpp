...
bool FastStringParser::parse_symbol(std::string_view input, char* output, size_t max_len) noexcept {
...
uint64_t FastStringParser::parse_uint64(std::string_view input) noexcept {
    uint64_t result = 0;
    for (char c : input) {
...
double FastStringParser::parse_price(std::string_view input) noexcept {
    double result = 0.0;
    double fraction = 0.0;
...
bool FastStringParser::is_valid_symbol_fast(std::string_view symbol) noexcept {
